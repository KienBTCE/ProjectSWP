<%-- 
    Document   : AddEmployeeView
    Created on : Mar 2, 2025, 11:30:07 PM
                        ...
                        <div class="form-container">
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <select class="form-select" name="txtRoleId" required>
                                    ...
                                    <option value="3">3-Order Manager</option>
                                    <option value="4">4-Warehouse Manager</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <input type="text" class="form-control" name="txtPhoneNumber" required>
                            </div>
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <input type="date" class="form-control" name="txtCreatedDate"required>
                            </div>
