...
<html lang="vi">
    ...
    <body>
        <main style="background: white; padding: 20px; border-radius: 10px">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <table style="width: 100%; border-collapse: collapse; ">
                            <tr style="height: 60px;">
                                ...
                                <th class="th" style="width: 18%;">Subtotal</th>
                            </tr>
                            <tr>
                                <td class="td"><img src="./img/2Tron.jpg" alt="" width="105px"></td>
                    ...
                    <div class="col-md-4"
                         style="border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); padding: 20px;">
                        ...
                        Ap tra coi A, My Huong Ward, My Tu district, Soc Trang province</p>
                    </div>
                </div>
                <br>
        ...
        <script>
            let currentStep = 0; // Thay đổi bước hiện tại theo trạng thái đơn hàng
